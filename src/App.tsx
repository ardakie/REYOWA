        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex justify-center items-center">
            <div className="w-full flex justify-center">
              <div className="w-full max-w-[900px] scale-[0.4] md:scale-[0.6] lg:scale-[0.7] xl:scale-[0.8] origin-top">
                <svg viewBox="0 0 900 280" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
                  ...
                  <g id="cup" filter="url(#sk)" className="animate-cup-move">
                    ...
                    <line x1="28"  y1="148" x2="25" y2="156" stroke="#111" strokeWidth="2.2" strokeLinecap="round"/>
                    <line x1="28"  y1="156" x2="22" y2="156" stroke="#111" strokeWidth="2.2" strokeLinecap="round"/>
                    <line x1="32"  y1="148" x2="31" y2="156" stroke="#111" strokeWidth="1.6" strokeLinecap="round"/>
                  </g>
                  ...
                  <g id="granules" filter="url(#sk)" className="animate-gran-move">
                    ...
                    <ellipse cx="80"  cy="170" rx="7.5" ry="4.5" fill="#fafaf7" stroke="#111" strokeWidth="2.2" transform="rotate(-13,80,170)"/>
                  </g>
                  ...
                  <g id="panel" filter="url(#sk)" className="animate-panel-move">
                    ...
                    <ellipse cx="47" cy="131" rx="6"   ry="4"   fill="#fafaf7" stroke="#222" strokeWidth="1.9" transform="rotate(5,47,131)"/>
